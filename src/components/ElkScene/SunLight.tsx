...
//
// Ambient intensity is deliberately INVERSE to the directional light's
// intensity: at night the sky is dark and low-intensity, so ambient is
// boosted to keep foreground materials (elk, trees, ground) legible
// against it; at day the directional light already does the work, so
// ambient eases off and lets materials read as naturally darker than the
// bright sky. Without this, dark foreground colors sink into a dark sky
// and everything reads as one flat tone.
